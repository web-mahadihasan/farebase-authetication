...
const Login = () => {
  ...
  const handleSingIn = (providerName) => {
    ...
    .then((result)=>{
      ...
      result && navigate("/login/user")
    }).catch(error => {
      setLogInUser(null)
      alert `User don't permission to login`
      console.log(error)
    })
  }
    ...
    <div className="w-full flex justify-center my-10">
      <div className=" p-4 rounded-md shadow sm:p-8 dark:bg-gray-50 dark:text-gray-800">
        ...
        <div className="my-6 space-y-4">
          <button
            onClick={() => handleSingIn(googleProvider)}
          ...
          <button
            onClick={() => handleSingIn(githubProvider)}
          ...
          <button
            onClick={() => handleSingIn(twitterProvider)}
